          ...
          <Accordion.Body>
            ...
            <div className="condition-grid">
              <ul className="condition-list">
                ...
                <li className="condition-item">
                  A previous severe allergic reaction to hydroxocobalamin,
                  Vitamin B12, or cyanocobalamin (Nascobal, Cobolin, Cyomin, and
                  others).
                </li>
              </ul>
            </div>
            <p className="treatment-text-2">
              We have the right to refuse treatment or request a letter of
              consent from your medical practitioner before treatment.
            </p>
          </Accordion.Body>
        </Accordion.Item>
      </Accordion>
