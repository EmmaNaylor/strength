  ...
  return (
    <div className="condition-grid">
      ...
      <ul className="condition-list-dual">
        ...
        <li className="condition-item">Bowel conditions</li>
      ...
      <ul className="condition-list-dual">
        ...
        <li className="condition-item">Concussion Disorders</li>
        <li className="condition-item">Head, Neck, Back injuries</li>
        <li className="condition-item">Joint aches</li>
        <li className="condition-item">Injuries</li>
      </ul>
    </div>
  );
};
